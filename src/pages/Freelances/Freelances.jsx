...
function Freelances() {
    const { data, error } = useFetch(`http://localhost:8000/freelances`)
    ...
    return (
        <div>
            ...
            {!freelancersList ? (
                <div className="mt-5 d-flex justify-content-center" data-testid="loader">{/* loader : îcone de chargement */}
